                ...
                <div class="p-8">
                    <form method="POST" action="{{ route('users.store') }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="name" class="block mt-2 w-full dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100" type="text" name="name" :value="old('name')" required autofocus placeholder="Enter full name" />
                        ...
                        <div>
                            ...
                            <x-text-input id="email" class="block mt-2 w-full dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100" type="email" name="email" :value="old('email')" required placeholder="email@example.com" />
                        ...
                        <div>
                            ...
                            <select id="role" name="role" class="block mt-2 w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm" required>
                                ...
                                @foreach($roles as $roleKey => $roleName)
                                    <option value="{{ $roleKey }}" {{ old('role') == $roleKey ? 'selected' : '' }}>{{ $roleName }}</option>
                                @endforeach
                            </select>
                        ...
                        <div>
                            ...
                            <x-text-input id="password" class="block mt-2 w-full dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100" type="password" name="password" required placeholder="Enter password" />
                        ...
                        <div>
                            ...
                            <x-text-input id="password_confirmation" class="block mt-2 w-full dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100" type="password" name="password_confirmation" required placeholder="Confirm password" />
