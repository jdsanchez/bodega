    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form action="{{ route('product-types.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                        @csrf
                        ...
                        <div class="border-b border-gray-200 dark:border-gray-700 pb-6">
                            ...
                            <div class="grid grid-cols-1 gap-6">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="name" class="block mt-2 w-full dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100" type="text" name="name" :value="old('name')" required autofocus placeholder="Ej: Tela de Algodón" />
                                ...
                                <div>
                                    ...
                                    <div class="mt-2 flex items-center gap-4">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">JPG, PNG (MAX. 2MB). Opcional.</p>
                                        </div>
                                    </div>
