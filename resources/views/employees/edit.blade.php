                        ...
                        <div class="border-b border-gray-200 dark:border-gray-700 pb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="first_name" class="block mt-2 w-full dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100" type="text" name="first_name" :value="old('first_name', $employee->first_name)" required placeholder="Juan" />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="last_name" class="block mt-2 w-full dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100" type="text" name="last_name" :value="old('last_name', $employee->last_name)" required placeholder="Pérez" />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="dpi" class="block mt-2 w-full dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100" type="text" name="dpi" :value="old('dpi', $employee->dpi)" required placeholder="1234567890101" />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="nit" class="block mt-2 w-full dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100" type="text" name="nit" :value="old('nit', $employee->nit)" placeholder="1234567-8" />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="birth_date" class="block mt-2 w-full dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100" type="date" name="birth_date" :value="old('birth_date', $employee->birth_date?->format('Y-m-d'))" />
                                ...
                                <div>
                                    ...
                                    @if($employee->photo)
                                        <div class="mt-2 mb-2">
                                            <img src="{{ Storage::url($employee->photo) }}" alt="{{ $employee->full_name }}" class="w-20 h-20 rounded-full object-cover border-2 border-gray-300 dark:border-gray-600">
                                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Foto actual</p>
                                        </div>
                                    @endif
                        ...
                        <div class="border-b border-gray-200 dark:border-gray-700 pb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="phone" class="block mt-2 w-full dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100" type="text" name="phone" :value="old('phone', $employee->phone)" placeholder="2234-5678" />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="mobile" class="block mt-2 w-full dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100" type="text" name="mobile" :value="old('mobile', $employee->mobile)" placeholder="5555-1234" />
                        ...
                        <div class="border-b border-gray-200 dark:border-gray-700 pb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="hire_date" class="block mt-2 w-full dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100" type="date" name="hire_date" :value="old('hire_date', $employee->hire_date?->format('Y-m-d'))" required />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="start_date" class="block mt-2 w-full dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100" type="date" name="start_date" :value="old('start_date', $employee->start_date?->format('Y-m-d'))" />
                                ...
                                <div class="md:col-span-2">
                                    <div class="flex items-center">
                                        <input id="is_active" type="checkbox" name="is_active" value="1" {{ old('is_active', $employee->is_active) ? 'checked' : '' }} class="w-4 h-4 text-indigo-600 bg-gray-100 border-gray-300 rounded focus:ring-indigo-500 dark:focus:ring-indigo-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                        <label for="is_active" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Empleado activo</label>
                                    </div>
                                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Desmarcar si el empleado ya no trabaja en la empresa</p>
