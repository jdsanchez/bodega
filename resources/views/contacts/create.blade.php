                        ...
                        <div class="border-b border-gray-200 dark:border-gray-700 pb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <x-text-input id="name" class="block mt-2 w-full dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100" type="text" name="name" :value="old('name')" required autofocus placeholder="Ej: Juan Pérez López" />
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <div class="mt-2 flex items-center gap-4">
                                        <div id="photo-preview" class="w-20 h-20 rounded-full bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center text-white text-xl font-bold overflow-hidden">
                                            <span id="initials-placeholder">?</span>
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">JPG, PNG (MAX. 2MB). Se mostrará un avatar por defecto si no se sube una foto.</p>
                                        </div>
                                    </div>
                        ...
                        <div class="border-b border-gray-200 dark:border-gray-700 pb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="whatsapp" class="block mt-2 w-full dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100" type="text" name="whatsapp" :value="old('whatsapp')" placeholder="5555-1234" />
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <x-text-input id="email" class="block mt-2 w-full dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100" type="email" name="email" :value="old('email')" placeholder="contacto@ejemplo.com" />
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <x-text-input id="website" class="block mt-2 w-full dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100" type="url" name="website" :value="old('website')" placeholder="https://www.ejemplo.com" />
                        ...
                        <div class="border-b border-gray-200 dark:border-gray-700 pb-6">
                            ...
                            <div class="grid grid-cols-1 gap-6">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="maps_url" class="block mt-2 w-full dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100" type="url" name="maps_url" :value="old('maps_url')" placeholder="https://maps.google.com/..." />
                        ...
                        <div class="pb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="nit" class="block mt-2 w-full dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100" type="text" name="nit" :value="old('nit')" placeholder="12345678-9" />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="dpi" class="block mt-2 w-full dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100" type="text" name="dpi" :value="old('dpi')" placeholder="1234 56789 0101" />
        ...
        document.getElementById('photo').addEventListener('change', function(e) {
            ...
            if (file) {
                ...
                reader.onload = function(e) {
                    ...
                    document.getElementById('initials-placeholder').classList.add('hidden');
                }
                reader.readAsDataURL(file);
            }
        });

        // Mostrar iniciales en el placeholder
        document.getElementById('name').addEventListener('input', function(e) {
            const name = e.target.value.trim();
            if (name && !document.getElementById('photo').files.length) {
                ...
                document.getElementById('initials-placeholder').textContent = initials || '?';
            }
        });
    </script>
    @endpush
