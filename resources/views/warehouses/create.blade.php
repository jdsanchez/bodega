                        ...
                        <div class="mt-6">
                            ...
                            <div class="flex items-center space-x-4">
                                <div class="flex-shrink-0">
                                    ...
                                    <div id="photoPlaceholder" class="w-32 h-32 rounded-lg bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center text-white">
                            ...
                            <div>
                                ...
                                <select name="status" id="status" required
                                    ...
                                    @foreach(App\Models\Warehouse::getStatuses() as $value => $label)
                                        <option value="{{ $value }}" {{ old('status', 'activa') === $value ? 'selected' : '' }}>
                                            {{ $label }}
                                        </option>
                                    @endforeach
                                </select>
